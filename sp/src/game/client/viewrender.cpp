...
// Estranged
//-----------------------------------------------------------------------------
static ConVar ae_ssao( "ae_ssao", "0", 0 );
static ConVar ae_ssao_allowed( "ae_ssao_allowed", "1", 0 );
...
// FAKEFACTORY SHADER EDITOR
	CLIENTEFFECT_MATERIAL( "postproc_desaturate" )
	CLIENTEFFECT_MATERIAL( "postproc_bokehdof" )
	CLIENTEFFECT_MATERIAL( "postproc_bokehdof2" )
	CLIENTEFFECT_MATERIAL( "postproc_bokehdof3" )
	CLIENTEFFECT_MATERIAL( "postproc_filmgrain" )
	CLIENTEFFECT_MATERIAL( "postproc_filmic" )
	CLIENTEFFECT_MATERIAL( "postproc_fxaa" )
	CLIENTEFFECT_MATERIAL( "postproc_uncharted" )
	CLIENTEFFECT_MATERIAL( "postproc_uncharted2" )
	CLIENTEFFECT_MATERIAL( "postproc_uncharted3" )

	CLIENTEFFECT_MATERIAL( "postproc_hpd" )
	CLIENTEFFECT_MATERIAL( "postproc_hpd2" )
	CLIENTEFFECT_MATERIAL( "postproc_hpd3" )
	CLIENTEFFECT_MATERIAL("postproc_curves")
	CLIENTEFFECT_MATERIAL( "postproc_watchdog" )

	CLIENTEFFECT_MATERIAL( "postproc_sharpen" )
	CLIENTEFFECT_MATERIAL( "postproc_sharpen2" )
	CLIENTEFFECT_MATERIAL( "postproc_sharpen3" )
	CLIENTEFFECT_MATERIAL( "postproc_vignette" )
	CLIENTEFFECT_MATERIAL( "postproc_glass_effect" )
	CLIENTEFFECT_MATERIAL( "postproc_glass_effect_2" )
	CLIENTEFFECT_MATERIAL( "postproc_gaussblur" )
	CLIENTEFFECT_MATERIAL( "postproc_gaussblur_xonly" )
	CLIENTEFFECT_MATERIAL( "postproc_artyflare" )
	CLIENTEFFECT_MATERIAL( "postproc_dragonborn" )

	//CLIENTEFFECT_MATERIAL( "postproc_cartoon" )
	//CLIENTEFFECT_MATERIAL( "postproc_cartoon2" )
	//CLIENTEFFECT_MATERIAL( "postproc_cartoon3" )
	//CLIENTEFFECT_MATERIAL( "postproc_sincity" )
	CLIENTEFFECT_MATERIAL( "postproc_softbloom" )
...
// *****************************
	CLIENTEFFECT_MATERIAL( "postproc_nightvision" )
// *****************************
// FAKKEFACTORY NIGHTVISION
// *****************************
...
// FAKEFACTORY ESTRANGED
	...
	CLIENTEFFECT_MATERIAL( "effects/ssao" )
	CLIENTEFFECT_MATERIAL( "effects/ssao_blurx" )
	CLIENTEFFECT_MATERIAL( "effects/ssao_blury" )
...
//-----------------------------------------------------------------------------
// FAKEFACTORY inline bool CViewRender::ShouldDrawEntities( void )
...
// FAKEFACTORY ESTRANGED
		...
		//	pRenderContext.GetFrom( materials );
		//	{
		//		PIXEVENT( pRenderContext, "EstrangedPostProcessing_PreViewModel" );
		//		
		//		ConVarRef ae_dof("ae_dof");
		//		if (ae_dof.GetBool() && CEstrangedSystemCaps::HasCaps(CAPS_ESTRANGED_DEPTHPASS) && CEstrangedSystemCaps::HasCaps(CAPS_SHADER_POSTPROCESS))
		//		{
		//			DrawEstrangedBokehDepthOfField();
		//		}
		//	}
		//	pRenderContext.SafeRelease();
		//}
...
void CViewRender::DrawWorldAndEntities( bool bDrawSkybox, const CViewSetup &viewIn, int nClearFlags, ViewCustomVisibility_t *pCustomVisibility )
{
	...
	// FAKEFACTORY ESTRANGED
	CMatRenderContextPtr pRenderContext( materials );
	// ALAN - I had to remove this in the 2013 merge, the enum member doesn't exist.
...
void CShadowDepthView::Draw()
{
	...
	// FAKEFACTORY: http://developer.valvesoftware.com/wiki/Env_projectedtexture/fixes
	// pRenderContext.GetFrom(materials);
	...
	// FALEFACTORY: http://developer.valvesoftware.com/wiki/Env_projectedtexture/fixes
	pRenderContext->PopRenderTargetAndViewport();
	// FALEFACTORY: http://developer.valvesoftware.com/wiki/Env_projectedtexture/fixes
	render->PopView( GetFrustum() );
...
void CBaseWorldView::SSAO_DepthPass()
{
	...
	//VPROF_BUDGET( "CSimpleWorldView::SSAO_DepthPass", VPROF_BUDGETGROUP_SHADOW_DEPTH_TEXTURING );
		VPROF_BUDGET( "Cinematic MOD - Depth Pass", _T("Cinematic MOD - Post Processing") );
// FAKEFACTORY ESTRANGED
...
{
	VPROF_BUDGET( "Cinematic Mod - HBAO", _T("Cinematic Mod - Post Processing") );
...
//	}
//
//	VPROF_BUDGET( "Estranged - Depth of Field", _T("Estranged - Post Processing") );
//
//	CMatRenderContextPtr pRenderContext( materials );
//
//	ITexture *pFrameBuffer = materials->FindTexture( "_rt_FullFrameFB", TEXTURE_GROUP_RENDER_TARGET );
