...
void CDetailObjectSystem::LevelInitPreEntity()
{
	...
	// FAKEFACTORY - DETAIL 
	// auskommentieren: siehe: http://developer.valvesoftware.com/wiki/Detail_props/Aspect_ratio_fix
...
// FAKEFACTORY DETAILS ASPECT RATIO FIX
// war:
...
void CDetailObjectSystem::UnserializeModelDict( CUtlBuffer& buf )
{
	...
	while ( --count >= 0 )
	{
		...
		// FAKEFACTORY ERLAUBE VERTEXLIGHT AUF DETAILSPRITES
		// Nachfolgender Block auskommentiert 
